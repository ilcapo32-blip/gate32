...
const dict = {
  es: {
    ...
    meeting_pick: "Al compartir, elige la pestaña de la reunión y marca «Compartir también el audio de la pestaña». Sin esa casilla solo se grabaría tu voz.",
    meeting_no_audio: "La pestaña se compartió sin audio, así que solo se habría grabado tu micrófono.",
    meeting_no_audio_hint: "Vuelve a intentarlo y marca la casilla «Compartir también el audio de la pestaña» abajo a la izquierda del selector. Tiene que ser una pestaña concreta: compartir una ventana o la pantalla entera no incluye el sonido.",
  ...
  en: {
    ...
    meeting_pick: "When sharing, pick the meeting tab and tick \"Also share tab audio\". Without that box only your own voice gets recorded.",
    meeting_no_audio: "The tab was shared without audio, so only your microphone would have been recorded.",
    meeting_no_audio_hint: "Try again and tick \"Also share tab audio\" at the bottom left of the picker. It has to be a specific tab: sharing a window or the whole screen doesn't include the sound.",
