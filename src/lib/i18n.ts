...
const dict = {
  es: {
    ...
    meeting_btn: "Grabar otra pestaña (reunión, vídeo, clase…)",
    meeting_start: "Elegir la pestaña y empezar",
    meeting_stop: "Detener la grabación ({t})",
    meeting_pick: "Al compartir, elige la pestaña que suena y marca «Compartir también el audio de la pestaña». Sin esa casilla no se graba el sonido. No funciona con Netflix, Disney+ y similares: el navegador bloquea la captura del contenido protegido.",
    meeting_no_audio: "La pestaña se compartió sin audio, así que no habría nada que transcribir salvo tu micrófono.",
    meeting_no_audio_hint: "Vuelve a intentarlo y marca la casilla «Compartir también el audio de la pestaña» abajo a la izquierda del selector. Tiene que ser una pestaña concreta: compartir una ventana o la pantalla entera no incluye el sonido. Si era una plataforma de streaming de pago, no hay casilla que valga: el contenido protegido no se puede capturar.",
    meeting_error: "No se ha podido capturar el audio de la pestaña.",
    meeting_error_hint: "Esto funciona en Chrome o Edge de escritorio. En Firefox y Safari el navegador no permite capturar el sonido de una pestaña.",
    meeting_consent: "⚠️ Si hay más personas (una reunión, una llamada), grabarlas exige su consentimiento: avísales antes de empezar.",
    meeting_mic_off: "sin tu micrófono: solo se ha grabado el audio de la pestaña",
    meeting_prefix: "pestana",
  ...
  en: {
    ...
    finishing: "finishing…",
    meeting_btn: "Record another tab (meeting, video, class…)",
    meeting_start: "Pick the tab and start",
    meeting_stop: "Stop recording ({t})",
    meeting_pick: "When sharing, pick the tab that is playing and tick \"Also share tab audio\". Without that box no sound is recorded. It will not work with Netflix, Disney+ and the like: the browser blocks capture of protected content.",
    meeting_no_audio: "The tab was shared without audio, so there would be nothing to transcribe beyond your microphone.",
    meeting_no_audio_hint: "Try again and tick \"Also share tab audio\" at the bottom left of the picker. It has to be a specific tab: sharing a window or the whole screen doesn't include the sound. If it was a paid streaming service, no checkbox will help: protected content cannot be captured.",
    meeting_error: "Couldn't capture the tab's audio.",
    meeting_error_hint: "This works on desktop Chrome or Edge. Firefox and Safari don't let a page capture a tab's sound.",
    meeting_consent: "⚠️ If other people are involved (a meeting, a call), recording them requires their consent: tell them before you start.",
