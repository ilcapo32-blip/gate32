...
const dict = {
  es: {
    ...
    meeting_btn: "Grabar una reunión (Meet, Zoom, Teams…)",
    meeting_start: "Elegir la pestaña de la reunión y empezar",
    meeting_stop: "Detener la reunión ({t})",
    meeting_pick: "Elige la pestaña de la videollamada y marca «Compartir también el audio de la pestaña». Sin esa casilla solo se grabaría tu voz. Se graba tu micrófono además del audio de la reunión.",
    meeting_consent: "⚠️ Grabar a otras personas exige su consentimiento. Avísales antes de empezar.",
    meeting_no_audio: "La pestaña se compartió sin audio, así que solo se habría grabado tu micrófono: media reunión.",
    meeting_prefix: "reunion",
    media_btn: "Transcribir un vídeo o directo de otra pestaña",
    media_start: "Elegir la pestaña y empezar",
    media_stop: "Detener ({t})",
    media_pick: "Elige la pestaña donde suena el vídeo y marca «Compartir también el audio de la pestaña». Tiene que ser una pestaña concreta: una ventana o la pantalla entera no llevan sonido. Tu micrófono no se usa.",
    media_drm: "No funciona con Netflix, Disney+, Prime Video y similares: el navegador impide capturar contenido protegido.",
    media_no_audio: "La pestaña se compartió sin audio, así que no habría nada que transcribir.",
    media_prefix: "video",
    tab_no_audio_hint: "Vuelve a intentarlo y marca la casilla «Compartir también el audio de la pestaña», abajo a la izquierda del selector. Tiene que ser una pestaña concreta: compartir una ventana o la pantalla entera no incluye el sonido.",
    tab_error: "No se ha podido capturar el audio de la pestaña.",
    tab_error_hint: "Esto funciona en Chrome o Edge de escritorio. En Firefox y Safari el navegador no permite capturar el sonido de una pestaña.",
    meeting_mic_off: "sin tu micrófono: solo se ha grabado el audio de la pestaña",
    recovery_note: "🎙️ Tu grabación está guardada en este navegador ({n} archivo(s), {size}). Descárgala ahora si te importa: se pierde al cerrar o recargar la pestaña.",
    recovery_btn: "Descargar la grabación",
    start_btn: "Transcribir",
    start_hint: "Comprueba el idioma y el modelo arriba antes de empezar.",
    ready_change: "Elegir otro archivo",
    big_file_note: "⚠️ Este archivo pesa {size}. Los archivos grandes fallan a menudo al abrirse: el navegador tiene que cargarlos enteros en memoria. Si falla, pártelo en trozos de media hora.",
    big_file_note_phone: "⚠️ Este archivo pesa {size} y estás en el móvil, donde la memoria es mucho más justa: es bastante probable que no se pueda abrir. Desde un ordenador tiene muchas más opciones.",
    ...
    done_failed: " · ⚠️ {n} bloque(s) de 30 s no se pudieron transcribir y faltan del texto",
    lang_note: "ℹ️ En este idioma los modelos pequeños pierden bastante precisión: Whisper se entrenó sobre todo con inglés y unas pocas lenguas más. Si el resultado sale flojo, no es tu audio — sube a «Preciso» y mejora mucho.",
    mark_btn: "Marcar este momento",
    mark_done: "Marcado ({n})",
    marks_one: "1 momento que marcaste",
    marks_many: "{n} momentos que marcaste",
    marks_next: "Ir al siguiente",
    doubt_one: "1 línea conviene comprobarla",
    doubt_many: "{n} líneas conviene comprobarlas",
    doubt_why_repeat: "Texto repetido: el modelo suele quedarse enganchado aquí.",
    doubt_why_fast: "Demasiadas palabras para lo que dura: puede haber texto inventado.",
    doubt_why_slow: "Varios segundos de audio para casi ninguna palabra: puede faltar texto.",
    doubt_why_boilerplate: "Frase de subtítulo que el modelo escribe cuando no hay voz.",
    fix_title: "Corregir en toda la transcripción",
    fix_hint: "El reconocimiento falla siempre en los mismos nombres propios. Corrígelo una vez y se arregla en todo el texto.",
    fix_find: "Lo que dice",
    fix_replace: "Lo que debería decir",
    fix_case: "Respetar mayúsculas",
    fix_apply: "Reemplazar todo",
    fix_count: "{n} coincidencia(s)",
    fix_undo: "Deshacer ({n} cambios)",
    retry_better: "Repetir con el modelo {model}",
    retry_hint: "¿Se ha saltado frases o ha entendido mal palabras? Con un modelo mayor mejora bastante. No hay que volver a cargar el archivo.",
    model_fast: "Rápido",
  ...
  en: {
    ...
    finishing: "finishing…",
    meeting_btn: "Record a meeting (Meet, Zoom, Teams…)",
    meeting_start: "Pick the meeting tab and start",
    meeting_stop: "Stop the meeting ({t})",
    meeting_pick: "Pick the video-call tab and tick \"Also share tab audio\". Without that box only your own voice gets recorded. Your microphone is recorded alongside the meeting audio.",
    meeting_consent: "⚠️ Recording other people requires their consent. Tell them before you start.",
    meeting_no_audio: "The tab was shared without audio, so only your microphone would have been recorded: half a meeting.",
    meeting_prefix: "meeting",
    media_btn: "Transcribe a video or stream from another tab",
    media_start: "Pick the tab and start",
    media_stop: "Stop ({t})",
    media_pick: "Pick the tab where the video is playing and tick \"Also share tab audio\". It has to be a specific tab: a window or the whole screen carries no sound. Your microphone is not used.",
    media_drm: "It won't work with Netflix, Disney+, Prime Video and the like: browsers block capture of protected content.",
    media_no_audio: "The tab was shared without audio, so there would be nothing to transcribe.",
    media_prefix: "video",
    tab_no_audio_hint: "Try again and tick \"Also share tab audio\" at the bottom left of the picker. It has to be a specific tab: sharing a window or the whole screen doesn't include the sound.",
    tab_error: "Couldn't capture the tab's audio.",
    tab_error_hint: "This works on desktop Chrome or Edge. Firefox and Safari don't let a page capture a tab's sound.",
    meeting_mic_off: "without your microphone: only the tab's audio was recorded",
    recovery_note: "🎙️ Your recording is held in this browser ({n} file(s), {size}). Download it now if it matters: it is lost when you close or reload the tab.",
    recovery_btn: "Download the recording",
    start_btn: "Transcribe",
    start_hint: "Check the language and model above before you start.",
    ready_change: "Choose another file",
    big_file_note: "⚠️ This file is {size}. Large files often fail to open: the browser has to hold all of it in memory. If it fails, split it into half-hour chunks.",
    big_file_note_phone: "⚠️ This file is {size} and you're on a phone, where memory is much tighter: there's a fair chance it won't open. A computer stands a much better chance.",
    ...
    done_failed: " · ⚠️ {n} 30-second chunk(s) could not be transcribed and are missing from the text",
    lang_note: "ℹ️ Small models lose a lot of accuracy in this language: Whisper was trained mostly on English and a handful of others. If the result looks poor, it isn't your audio — move up to \"Accurate\" and it improves a great deal.",
    mark_btn: "Mark this moment",
    mark_done: "Marked ({n})",
    marks_one: "1 moment you marked",
    marks_many: "{n} moments you marked",
    marks_next: "Go to the next one",
    doubt_one: "1 line worth checking",
    doubt_many: "{n} lines worth checking",
    doubt_why_repeat: "Repeated text: the model tends to get stuck here.",
    doubt_why_fast: "Too many words for how long it lasts: some may be invented.",
    doubt_why_slow: "Seconds of audio for almost no words: text may be missing.",
    doubt_why_boilerplate: "Subtitle boilerplate the model writes when there is no speech.",
    fix_title: "Fix across the whole transcript",
    fix_hint: "Speech recognition always trips on the same proper nouns. Correct it once and it is fixed everywhere.",
    fix_find: "What it says",
    fix_replace: "What it should say",
    fix_case: "Match case",
    fix_apply: "Replace all",
    fix_count: "{n} match(es)",
    fix_undo: "Undo ({n} changes)",
    retry_better: "Redo with the {model} model",
    retry_hint: "Skipped sentences, or words it got wrong? A larger model improves this a lot. No need to load the file again.",
    model_fast: "Fast",
